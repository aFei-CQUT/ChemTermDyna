...
临界点是气液共存曲线的终点，在此点上液相和气相的性质变得相同。临界温度是使气体无法仅通过加压而液化的最高温度。

对于CO2，临界压力Pc为7.38 MPa，临界温度Tc为31.1°C。
...
#figure(
  table(
    columns: 5,
    [温度 (°C)], [压力 (atm)], [Δh\* (mm)], [CO2比容 (m³/kg)], [K (kg/m²)],
    [25], [78], [36], [0.00124], [29.038],
  ),
  caption: [质面比常数K值计算]
) <k-value-calculation>
...
原始数据: 温度 T = 10°C, 压力 P = 2.3 MPa, 高度 h = 0 mm, 毛细管顶端刻度 h0 = 359 mm, 质面比常数 k = 29.038 kg/m²
...
这种表示方法将计算公式放在数学环境中，而描述性文字保留在常规文本中。这样可以清晰地区分计算步骤和解释说明，同时保持数学公式的准确性和可读性。
...
#figure(
  table(
    ...
    [10], [4.1], [188], [0.005889], [],
    [10], [4.4], [208], [0.005200], [],
    [10], [4.55], [227], [0.004546], [相变点],
    [10], [4.58], [232], [0.004374], [],
    [10], [4.6], [250], [0.003754], [],
    [10], [4.6], [255], [0.003582], [],
    [10], [4.62], [260], [0.003409], [],
    [10], [4.65], [265], [0.003237], [],
    [10], [4.65], [275], [0.002893], [],
    [10], [4.65], [270], [0.003065], [],
    [10], [4.65], [275], [0.002893], [],
    [10], [4.65], [280], [0.002721], [],
    [10], [4.65], [285], [0.002548], [],
    [10], [4.65], [290], [0.002376], [],
    [10], [4.68], [295], [0.002204], [],
    [10], [4.7], [300], [0.002032], [],
    [10], [4.71], [305], [0.001860], [],
    [10], [4.85], [316], [0.001481], [],
    [10], [4.92], [320], [0.001343], [],
    [10], [5.12], [325], [0.001171], [],
    [10], [5.45], [330], [0.000999], [],
    [10], [6.6], [335], [0.000827], [],
    [10], [8.0], [337], [0.000758], [],
  ),
...
这个表格展示了10°C时CO2的压力、高度和计算得到的比容数据。表格被分成两部分以提高可读性，并使用了续表的形式。相变点已在备注中标出。这些处理后的数据可用于绘制PV曲线和进行后续分析。
...
#figure(
  image("../../experiment2_res/P-V_diagram.png", width: 70%),
  caption: [CO2的PV曲线]
) <pv-curves>
...
for df in processed_data
    plot!(df.V, df.P, label="T = $(df.T[1])°C", marker=:circle, markersize=4)
    # 用不同的标记显示带星号的点
