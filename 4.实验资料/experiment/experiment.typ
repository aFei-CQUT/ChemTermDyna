...
$ V_(#ca("CH3COOH")) = 500 / 6.50725 = 142.56183 m l $ <eq6>

由@eqt:eq1 求得 $V_(#ca("H2O"))$:

$ V_(#ca("H2O")) = 500 - 142.56183 = 357.43816 m l $ <eq7>

== 求解结果
+ 无水乙酸(冰醋酸)体积: $V_(#ca("CH3COOH")) = 142.56183 m l$ 
+ 水的体积: $V_(#ca("H2O")) = 357.43816 m l$

== 配置步骤
+ 量取水的体积$V_(#ca("H2O")) = 350 m l$
+ 小心量取无水乙酸(冰醋酸)体积$V_(#ca("CH3COOH")) = 142.56183 m l$
+ 将步骤2中量取的酸缓慢加入步骤1中量取的水中边加边搅拌,转移至容量瓶中定容。

== 注意事项

实际操作时,应先加入约357.43816 ml水,再缓慢加入142.56183 ml无水乙酸,最后用水稀释至500ml刻度,以确保安全和准确。
